...
const props = defineProps({
  ...
  logs: Array, // ActivityLog modelleri buradan geliyor
   healthChecks: Object, // istersen backend'den gönderip kullanabilirsin
});
...
// Sistem sağlık seviyesine göre renk
const healthColor = computed(() => {
  const level = props.stats?.system_health_level || 'ok';
...
// Üst görünüm istatistik kartları
const formattedStats = computed(() => [
  ...
  },
  {
    ...
    icon: Activity,
    color: healthColor.value, // ✅ dinamik renk
    badge: true
  },
]);

// Hızlı işlemler kartları
          ...
          <div class="flex items-start gap-4">
            ...
            <div>
              ...
              <p class="text-gray-600 leading-relaxed">
                Tüm sistemler izleniyor. Sistem genel durumu:
                <span
                  class="inline-flex items-center ml-1 px-3 py-1 rounded-full text-sm font-semibold"
                  :class="{
                    'bg-emerald-100 text-emerald-700': stats.system_health_level === 'ok',
                    'bg-orange-100 text-orange-700': stats.system_health_level === 'warning',
                    'bg-red-100 text-red-700': stats.system_health_level === 'critical',
                  }"
                >
                  <span
                    class="w-2 h-2 rounded-full mr-2 animate-pulse"
                    :class="{
                      'bg-emerald-500': stats.system_health_level === 'ok',
                      'bg-orange-500': stats.system_health_level === 'warning',
                      'bg-red-500': stats.system_health_level === 'critical',
                    }"
                  ></span>
                  {{ stats.system_health }}
                </span>
                ...
                <div class="flex-1">
                  <h4
                    :class="[
                      ...
                      getColorClasses(link.color).linkHover,
